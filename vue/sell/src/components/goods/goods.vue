<template>
  <div>
    <!-- 由于vue2.0不支持template下main挂载多个根元素，所以在此创建div将 goods 和food组件包裹进来 -->
    <div class="goods">
    ...
    <!-- ref="food" 用来提供给父组件一个接口，用来调用子组件的方法的入口 -->
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      // 方法名称前加下划线，一般为私用方法，不能被父组件调用,例如，_drop()；不加下划线的，例如，selectMenu(),一般为公用方法，可以被父组件调用
